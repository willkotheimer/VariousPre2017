...
<h3><a href="?page=quick-event-manager/settings.php&tab=template">'.__('Template', 'quick-event-manager').'</a></h3>
...
function qem_event_settings() {
    ...
    foreach (explode( ',',$event['sort']) as $name) {
        ...
        switch ( $name ) {
            ...
            break;
            case 'field2':
            $options = '<input type="text" style="border:1px solid blue; width:10em;" name="start_label" . value ="' . $event['start_label'] . '" /> {'.__('start time', 'quick-event-manager').'} <input type="text" style="border:1px solid blue; width:10em;" name="finish_label" . value ="' . $event['finish_label'] . '" /> {'.__('end time', 'quick-event-manager').'}';
            break;
            case 'field3':
            $options = '<input type="text" style="border:1px solid blue; width:6em;" name="location_label" . value ="' . $event['location_label'] . '" /> {'.__('venue', 'quick-event-manager').'}';
            break;
            case 'field4':
            $options = '<input type="text" style="border:1px solid blue; width:10em;" name="address_label" . value ="' . $event['address_label'] . '" /> {'.__('address', 'quick-event-manager').'}';
            break;
            case 'field5':
            $options = '<input type="text" style="border:1px solid blue; width:10em;" name="url_label" . value ="' . $event['url_label'] . '" /> {url}';
            break;
            case 'field6':
            $options = '<input type="text" style="border:1px solid blue; width:10em;" name="cost_label" . value ="' . $event['cost_label'] . '" /> {'.__('cost', 'quick-event-manager').'}';
            break;
            case 'field7':
            $options = '<input type="text" style="border:1px solid blue; width:10em;" name="organiser_label" . value ="' . $event['organiser_label'] . '" /> {'.__('organiser', 'quick-event-manager').'}&nbsp;<input type="checkbox" name="show_telephone"' . $event['show_telephone'] . ' value="checked" /> '.__('Show organiser\'s contact details', 'quick-event-manager').' ';
            break;
            case 'field8':
...
<tr>
    ...
    <tr>
    <td><input type="checkbox" name="showcategory" value="checked" ' . $display['showcategory'] . ' /></td>
    ...
    <tr>
    <td colspan="2"><b>'.__('Note:', 'quick-event-manager').'</b>'.__('The map will only display if you have a valid address.', 'quick-event-manager').'</td>
    </tr>
    <tr>
    ...
    <td><input type="checkbox" name="catallevents" ' . $display['catallevents'] . ' value="checked" /><br><span class="description">'.__('This uses the URL set on the', 'quick-event-manager').' <a href="?page=quick-event-manager/settings.php&tab=display">'.__('Event Display', 'quick-event-manager').'</a> '.__('page', 'quick-event-manager').'.</span></td>
    </tr>
    <tr>
    <td width="30%">'.__('Caption', 'quick-event-manager').'</td>
...
function qem_styles() {
    ...
    &emsp;&emsp;&emsp;&emsp;&emsp;<input type="checkbox" name="vanillamonth" ' . $style['vanillamonth'] . ' value="checked" /> '.__('Show the full month name', 'quick-event-manager').'</td>
    </tr>
    <tr>
...
Header CSS:<br>
    ...
    <tr>
    <td width="30%">'.__('Background', 'quick-event-manager').'</td>
...
function qem_register (){
    ...
    <p>Use the <a href="?page=quick-event-manager/settings.php&tab=settings">Event Settings</a> to enable the registration form. You can then manage forms for individual events using the event editor</p>
    <table width="100%">
    <tr>
    <td colspan="3"><h2>'.__('General Settings', 'quick-event-manager').'</h2></td></tr>
    <tr>
    <td width="5%"><input type="checkbox" name="formborder"' . $register['formborder'] . ' value="checked" /></td>
...
<tr>
    ...
    foreach ($sort as $name) {
        ...
        else $content .= '<input type="text" style="border: 1px solid #343838;" name="'.$input.'" value="' . $register[$input] . '" />';
        $content .= '</td></tr>';
    }
    $content .='</tbody>
    </table>
    ...
    <tr>
    <td colspan="2">'.__('Background', 'quick-event-manager').'</td>
    <td><input type="text" class="qem-color" label="background" name="submitbackground" value="' . $register['submitbackground'] . '" /></td>
    </tr>
    <tr>
    <td colspan="2">'.__('Hover', 'quick-event-manager').'</td>
    <td><input type="text" class="qem-color" label="hoverbackground" name="submitbackground" value="' . $register['hoversubmitbackground'] . '" /></td>
    </tr>
    <tr>
