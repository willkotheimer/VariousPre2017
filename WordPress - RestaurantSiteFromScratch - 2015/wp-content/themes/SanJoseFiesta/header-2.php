...
<div class="wrap ">
	...
	<div class="subMenu" >
	 	<div class="inner">
	 		<a href="<?php echo get_home_url(); ?>#s1" class="subNavBtn">SOCIAL</a>
	...
	<div class="top1"><img src="<?php echo get_bloginfo( 'template_directory' ).'/images/'; ?>logo.png" style="height:100px; width: auto; " /></div>
<div class="top2"><span>San Jose Fiesta</span></div>